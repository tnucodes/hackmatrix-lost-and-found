...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-neo-bg flex flex-col items-center justify-center p-6 font-sans">
      ...
      >
        <h2 className="text-3xl sm:text-4xl font-black uppercase tracking-tighter mb-6 bg-neo-yellow inline-block px-3 py-1.5 border-4 border-black shadow-[3px_3px_0_#000]">
          Welcome Back 👋
        </h2>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5">
          ...
          <button type="submit" className="w-full bg-neo-green p-4 text-lg mt-2 font-black uppercase tracking-widest neo-button text-black shadow-[3px_3px_0_#000]">
            Log In
          </button>
        </form>
        ...
        <p className="mt-6 font-bold text-center text-sm text-gray-600">
          New to Campus Trust?{" "}
          <Link href="/signup" className="text-blue-600 underline font-black hover:text-blue-800">
            Sign up here!
          </Link>
        </p>
      </motion.div>
